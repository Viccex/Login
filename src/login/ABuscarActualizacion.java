 ...
 * @author cliente
 */
public class ABuscarActualizacion extends javax.swing.JFrame 
{
    /**
     * Creates new form TercerMenu
     */
    public ABuscarActualizacion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABuscarActualizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ABuscarActualizacion().setVisible(true);
            }
        });
    }

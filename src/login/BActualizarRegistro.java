 ...
 * @author cliente
 */
public class BActualizarRegistro extends javax.swing.JFrame 
{
    /**
     * Creates new form TercerMenu
     */
    public BActualizarRegistro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BActualizarRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BActualizarRegistro().setVisible(true);
            }
        });
    }

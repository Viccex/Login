 ...
 * @author cliente
 */
public class BInsertarActualizacion extends javax.swing.JFrame 
{
    /**
     * Creates new form TercerMenu
     */
    public BInsertarActualizacion() {
        initComponents();
    }
    ...
    private void B1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B1ActionPerformed
        try
        {
            ...
            cliente.excecute("http://127.0.0.1/Api/a_inventarioR.php?numero_factura="+numero+"&cantidad="+cantidad+"&fecha_compra="+fecha+"&id_producto="+id);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BInsertarActualizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BInsertarActualizacion().setVisible(true);
            }
        });
    }

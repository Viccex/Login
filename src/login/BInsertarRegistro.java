 ...
 * @author cliente
 */
public class BInsertarRegistro extends javax.swing.JFrame 
{
    /**
     * Creates new form TercerMenu
     */
    public BInsertarRegistro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BInsertarRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BInsertarRegistro().setVisible(true);
            }
        });
    }

 ...
 * @author cliente
 */
public class BEliminarRegistro extends javax.swing.JFrame 
{
    /**
     * Creates new form TercerMenu
     */
    public BEliminarRegistro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BEliminarRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BEliminarRegistro().setVisible(true);
            }
        });
    }

 ...
 * @author cliente
 */
public class CInsertarVenta extends javax.swing.JFrame {
    DefaultTableModel modelo;
    /**
     * Creates new form Ventas
     */
    public CInsertarVenta() 
    {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CInsertarVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CInsertarVenta().setVisible(true);
            }
        });
    }

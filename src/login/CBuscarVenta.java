 ...
 * @author cliente
 */
public class CBuscarVenta extends javax.swing.JFrame 
{
    /**
    ...
    private void initComponents() {
        ...
        LID.setText("Ingrese su numero de compra:");
    ...
    private void B1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B1ActionPerformed
        try
        {
            ...
            cliente.excecute("http://127.0.0.1/Api/v_productos.php?numero_compra="+num);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CBuscarVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CBuscarVenta().setVisible(true);
            }
        });
    }

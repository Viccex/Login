 ...
 * @author cliente
 */
public class BBuscarInventario extends javax.swing.JFrame 
{
    /**
     * Creates new form TercerMenu
     */
    public BBuscarInventario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(PFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 430, 320));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BBuscarInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BBuscarInventario().setVisible(true);
            }
        });
    }

 ...
 * @author cliente
 */
public class ABuscarVenta extends javax.swing.JFrame 
{
    /**
    ...
    private void initComponents() {
        ...
        LMonto.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        LMonto.setForeground(new java.awt.Color(255, 255, 255));
        LMonto.setText("Monto total de la compra:");
        ...
        LID.setText("Ingrese su numero de factura:");
                        ...
                        .addGroup(PFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(PFondoLayout.createSequentialGroup()
                                ...
                                .addGroup(PFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(TMonto, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        getContentPane().add(PFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 490, 330));
            ...
            HttpClient cliente=new HttpClient (new OnHttpRequestComplete() 
            {
                ...
                public void onComplete(Response status) 
                {
                    if(status.isSuccess())
                    {
                        ...
                        String fechaWeb=r.getJSONObject("0").get("fecha_venta").toString();
                        String montoWeb=r.getJSONObject("0").get("monto_total").toString();
                        
                        TFecha.setText(fechaWeb);
                        TMonto.setText(montoWeb);
                    }
                    throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
                }
            });
            String num = TNumero.getText();
            cliente.excecute("http://127.0.0.1/Api/v_productos.php?numero_factura="+num);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABuscarVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ABuscarVenta().setVisible(true);
            }
        });
    }

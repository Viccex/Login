 ...
 * @author cliente
 */
public class TercerMenu extends javax.swing.JFrame 
{
    String id;
    /**
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(38, 38, 38)
                        .addComponent(L1, javax.swing.GroupLayout.PREFERRED_SIZE, 530, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        try
        {
            HttpClient cliente=new HttpClient (new OnHttpRequestComplete() 
            {
                ...
                public void onComplete(Response status) 
                {
                    if(status.isSuccess())
                    {
                        L1.setText(status.getResult());
                    }
                    throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
                }
            });
            if(TF1.getText().equals(id="1"))
            {
                cliente.excecute("http://127.0.0.1/Api/index_RP.php?id_producto="+id);
            }
            else
            {
                cliente.excecute("http://127.0.0.1/Api/index_RP.php");
                /*L1.setText("El id no es valida");*/
            }
        }
